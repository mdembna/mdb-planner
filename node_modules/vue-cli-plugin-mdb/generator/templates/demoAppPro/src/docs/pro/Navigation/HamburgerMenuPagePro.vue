<template>
  <mdb-container>
    <mdb-row class="mt-5 align-items-center justify-content-start">
      <h4 class="demo-title"><strong>Hamburger Menu Pro</strong></h4>
      <a href="https://mdbootstrap.com/docs/vue/navigation/hamburger-menu/?utm_source=DemoApp&utm_medium=MDBVuePro" waves-fixed class="border grey-text px-2 border-light rounded ml-2" target="_blank"><mdb-icon icon="graduation-cap" class="mr-2"/>Docs</a>
    </mdb-row>
    <hr />
    ...
    <mdb-col md="6">
      <mdb-accordion icon hamburger :panes="panes">
        <ul class="list-unstyled d-flex justify-content-center pt-5 red-text">
          ...
          <li><i class="fas fa-life-ring mr-3 fa-2x" aria-hidden="true"></i></li>
    ...
    <mdb-container>
      ...
      <!--/.Navbar-->
      <!--Navbar-->
      <mdb-navbar color="purple" class="mt-2 lighten-4" hamburger togglerClass="purple darken-3 text-white">
        <!-- mdbNavbar brand -->
        <mdb-navbar-brand>
          mdbNavbar
        </mdb-navbar-brand>
      ...
      <!--/.Navbar-->
      <!--Navbar-->
      <mdb-navbar color="cyan" class="mt-2 lighten-4" hamburger togglerClass="cyan darken-4 text-white">
        <!-- mdbNavbar brand -->
        <mdb-navbar-brand>
          mdbNavbar
        </mdb-navbar-brand>
      ...
      <!--/.Navbar-->
      <!--Navbar-->
      <mdb-navbar color="green" class="mt-2 lighten-4" hamburger togglerClass="aqua-gradient darken-4 text-white">
        <!-- mdbNavbar brand -->
        <mdb-navbar-brand>
          mdbNavbar
        </mdb-navbar-brand>
      ...
      <!--/.Navbar-->
      <!--Navbar-->
      <mdb-navbar color="orange" class="mt-2 lighten-4" hamburger togglerClass="peach-gradient darken-4 text-white">
        <!-- mdbNavbar brand -->
        <mdb-navbar-brand>
          mdbNavbar
        </mdb-navbar-brand>
