      ...
      <mdb-row>
        <mdb-col md="8" class="mx-auto">
          <mdb-jumbotron class="pt-4">
            ...
            <mdb-list-group>
              <mdb-nav-item class="list-group-item list-group-item-action" to="/css/pro/background">
                <h5 class="justify-content-between d-flex align-items-center">
                  Background Image<mdb-icon icon="angle-right"/>
                </h5>
              </mdb-nav-item>
              <mdb-nav-item class="list-group-item list-group-item-action" to="/css/pro/gradient">
                <h5 class="justify-content-between d-flex align-items-center">
                  Gradient<mdb-icon icon="angle-right"/>
                </h5>
              </mdb-nav-item>
              <mdb-nav-item class="list-group-item list-group-item-action" to="/css/pro/parallax">
                <h5 class="justify-content-between d-flex align-items-center">
                  Parallax<mdb-icon icon="angle-right"/>
                </h5>
              </mdb-nav-item>
              <mdb-nav-item class="list-group-item list-group-item-action" to="/css/pro/scrollbar">
                <h5 class="justify-content-between d-flex align-items-center">
                  Scrollbar <mdb-icon icon="angle-right"/>
                </h5>
              </mdb-nav-item>
