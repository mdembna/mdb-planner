        ...
        <mdb-col md="8" class="mx-auto">
          <mdb-jumbotron class="pt-4">
            ...
            <mdb-list-group>
              ...
              <mdb-nav-item class="list-group-item list-group-item-action" to="/tables/pro/table-editable">
                <h5 class="justify-content-between d-flex align-items-center">
                  Editable Table <mdb-icon icon="angle-right"/>
                </h5>
              </mdb-nav-item>
              <mdb-nav-item class="list-group-item list-group-item-action" to="/tables/pro/table-filter">
                <h5 class="justify-content-between d-flex align-items-center">
                  Datatable Filter<mdb-icon icon="angle-right"/>
                </h5>
              </mdb-nav-item>
            </mdb-list-group>
            <!-- endRemoveIf(free) -->
